...
<a href="/conversations/" class="nav-link d-flex align-items-baseline justify-content-start" id="conversations">მესიჯები</a></li>
  ...
  function main() {
    ...
    // ფილტრაცია
    var url = window.location.href;
    if (url == "https://my.ug.edu.ge/conversations/") {
